...
public class Account implements Initializable {
    ...
    public void Manage_Account_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("manageAccount.fxml")));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void Get_Information_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("ClientAppointments.fxml")));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
